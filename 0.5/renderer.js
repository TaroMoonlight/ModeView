...
class SimpleRenderer {
  ...
  `;
      ...
      void main() {
        ...
        gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0); // ярко-красный
      }
    `;
    /*
    const fragSrc = `
    ...
    */
    ...
    console.log('aPosition location:', this.skyboxAttribs.aPosition);
  ...
  drawSkybox(camera) {
    ...
    console.log('Skybox Cubemap texture: ',this.cubeTexture);
    console.log('bindTexture error:', gl.getError());
